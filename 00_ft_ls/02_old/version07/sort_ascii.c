...
/*   Updated: 2017/01/14 19:40:24 by curquiza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 ** Trie le tableau de structure s_path par ordre ascii en tri par bulle
 */
...
/*void	ft_run(t_path **tab, int start1, int end1, int end2)
{
	t_path	**tmp;
	int		start2;
	int		cpt1;
