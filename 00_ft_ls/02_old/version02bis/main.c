...
/*   Updated: 2016/12/31 17:25:12 by curquiza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Correction de la version 2, maintenant j'arrive a récupérer le contenu de la
** structure qui elle meme est mise dans contente.
** Mais la manipulation de tout ca reste tres compliqué pour un debut de code.
*/
...
t_list	*ft_fill_argfiles(char **arg)
{
	...
	while (*arg)
	{
		ft_lstadd_back(&argfiles, ft_lstnew(ft_new_filestat(*arg), sizeof(*argfiles)));
		arg++;
	}
